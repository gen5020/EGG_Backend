...
se le informa al usuario el error se le informa al usuario. Si no, 
...
public class Ej3_Poo {

    public static void main(String[] args) {
      Operacion n1=new Operacion();
      n1.crearOperacion();
        System.out.println("SUMA= "+n1.sumar());
        System.out.println("Resta= "+n1.restar());
        System.out.println("Multiplicar= "+n1.multiplicar());
    }
